...
#     dplyr::mutate(class = "Step")
#
#   temp_cgm_data <-
#     cgm_data %>%
#     dplyr::filter(subject_id == temp_subject_id) %>%
#     dplyr::mutate(class = "CGM")
#
#   temp_hr_data <-
#     hr_data %>%
#     dplyr::filter(subject_id == temp_subject_id) %>%
...
#
#   x <-
#     rbind(temp_step_data[, c("accurate_time", "value", "class")],
#           temp_cgm_data[, c("accurate_time", "value", "class")],
#           temp_hr_data[, c("accurate_time", "value", "class")])
#
#   plot <-
#     time_plot_multiple(
#       x = x,
#       x_limit = c(1, 1000000),
#       class_color = wearable_color,
#       time_gap = 12
#     )
#
#   ggsave(
#     plot,
#     file = file.path("plot", paste0(temp_subject_id, "_plot.pdf")),
#     width = 14,
#     height = 9
#   )
#
...
#####hr vs step
####lagged correlation
dir.create("step_vs_hr")
unique(hr_data$subject_id)
unique(step_data$subject_id)

median(diff(hr_data$accurate_time))
...
# for (temp_subject_id in unique(step_data$subject_id)) {
#   cat(temp_subject_id, " ")
#   dir.create(file.path("step_vs_hr/", temp_subject_id))
#
#   temp_step_data <-
#     step_data %>%
#     dplyr::filter(subject_id == temp_subject_id) %>%
...
#   save(
#     lagged_cor_result,
#     file = file.path("step_vs_hr", temp_subject_id, "lagged_cor_result"),
#     compress = "xz"
#   )
#
#   evalutation_result <-
...
#   save(
#     evalutation_result,
#     file = file.path("step_vs_hr", temp_subject_id, "evalutation_result"),
#     compress = "xz"
#   )
#
#   ggsave(
#     evalutation_result[[2]],
#     filename = file.path("step_vs_hr", temp_subject_id, "evalutation.pdf"),
#     width = 7,
#     height = 5
#   )
#
...
#       y_color = unname(wearable_color["HR"]),
#       x_name = "Step",
#       y_name = "HR",
#       which = "global",
...
#   ggsave(
#     plot1,
#     filename = file.path("step_vs_hr", temp_subject_id, "globale_plot.pdf"),
#     width = 14,
#     height = 6
#   )
#
...
#   ggsave(
#     plot2,
#     filename = file.path("step_vs_hr", temp_subject_id, "max_plot.pdf"),
#     width = 14,
#     height = 6
#   )
#
#   plot3 <-
#     tryCatch(lagged_scatter_plot(
#       object = lagged_cor_result,
#       x_name = "Step",
#       y_name = "HR",
#       which = "max",
...
#   ggsave(
#     plot3,
#     filename = file.path("step_vs_hr", temp_subject_id, "scatter_plot.pdf"),
#     width = 7,
#     height = 7
#   )
# }
...
#     cat(temp_subject_id, " ")
#     load(file.path("step_vs_hr", temp_subject_id, "lagged_cor_result"))
...
# openxlsx::write.xlsx(
#   step_hr_result,
#   "step_vs_hr/step_hr_result.xlsx",
#   asTable = TRUE,
#   overwrite = TRUE
# )
# save(step_hr_result, file = "step_vs_hr/step_hr_result")

load("step_vs_hr/step_hr_result")
...
plot <-
  ...
  labs(x = "Shift time (Steps - HR, mins)",
...
plot
# ggsave(plot,
#        filename = "step_vs_hr/shift_time_vs_cor.pdf",
#        width = 7,
#        height = 7)
#
# ggsave(plot,
#        filename = "step_vs_hr/shift_time_vs_cor.png",
#        width = 7,
#        height = 7)
