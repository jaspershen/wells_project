...
###should remove the cgms that are zero

# for (temp_subject_id in unique(cgm_data$subject_id)) {
#   cat(temp_subject_id, " ")
#   dir.create(file.path("cgm_vs_hr/", temp_subject_id))
#
#   temp_cgm_data <-
#     cgm_data %>%
...
#   save(
#     lagged_cor_result,
#     file = file.path("cgm_vs_hr", temp_subject_id, "lagged_cor_result"),
#     compress = "xz"
#   )
#
#   evalutation_result <-
...
#   save(
#     evalutation_result,
#     file = file.path("cgm_vs_hr", temp_subject_id, "evalutation_result"),
#     compress = "xz"
#   )
#
#   ggsave(
#     evalutation_result[[2]],
#     filename = file.path("cgm_vs_hr", temp_subject_id, "evalutation.pdf"),
#     width = 7,
#     height = 5
#   )
#
...
#       x_color = unname(wearable_color["CGM"]),
...
#   ggsave(
#     plot1,
#     filename = file.path("cgm_vs_hr", temp_subject_id, "globale_plot.pdf"),
#     width = 14,
#     height = 6
#   )
#
...
#   ggsave(
#     plot2,
#     filename = file.path("cgm_vs_hr", temp_subject_id, "max_plot.pdf"),
#     width = 14,
#     height = 6
#   )
#
...
#   ggsave(
#     plot3,
#     filename = file.path("cgm_vs_hr", temp_subject_id, "scatter_plot.pdf"),
#     width = 7,
#     height = 7
#   )
# }
...
#     cat(temp_subject_id, " ")
#     load(file.path("cgm_vs_hr", temp_subject_id, "lagged_cor_result"))
...
# openxlsx::write.xlsx(
#   cgm_hr_result,
#   "cgm_vs_hr/cgm_hr_result.xlsx",
#   asTable = TRUE,
#   overwrite = TRUE
# )
# save(cgm_hr_result, file = "cgm_vs_hr/cgm_hr_result")
load("cgm_vs_hr/cgm_hr_result")
...
plot <-
  temp_data %>%
  dplyr::mutate(class = case_when(max_shift_time >= 0 ~ "shift_pos",
...
# ggsave(plot,
#        filename = "cgm_vs_hr/shift_time_vs_cor.pdf",
#        width = 7,
#        height = 10)
# 
# ggsave(plot,
#        filename = "cgm_vs_hr/shift_time_vs_cor.png",
#        width = 7,
#        height = 10)
